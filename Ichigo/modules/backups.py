...
import Ichigo.modules.sql.notes_sql as sql
from Ichigo import dispatcher, LOGGER, OWNER_ID, JOIN_LOGGER, SUPPORT_CHAT
from Ichigo.__main__ import DATA_IMPORT
...
# from Ichigo.modules.rules import get_rules
import Ichigo.modules.sql.rules_sql as rulessql

# from Ichigo.modules.sql import warns_sql as warnssql
import Ichigo.modules.sql.blacklist_sql as blacklistsql
from Ichigo.modules.sql import disable_sql as disabledsql

# from Ichigo.modules.sql import cust_filters_sql as filtersql
# import Ichigo.modules.sql.welcome_sql as welcsql
import Ichigo.modules.sql.locks_sql as locksql
from Ichigo.modules.connection import connected
...
def export_data(update, context):
    ...
    with open("Ichigo{}.backup".format(chat_id), "w") as f:
    ...
    context.bot.sendDocument(
        current_chat_id,
        document=open("Ichigo{}.backup".format(chat_id), "rb"),
        caption="*Successfully Exported backup:*\nChat: `{}`\nChat ID: `{}`\nOn: `{}`\n\nNote: This `Ichigo-Backup` was specially made for notes.".format(
            chat.title, chat_id, tgl
        ),
        timeout=360,
    ...
    os.remove("Ichigo{}.backup".format(chat_id))  # Cleaning file
