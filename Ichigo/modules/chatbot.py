...
from Ichigo import AI_API_KEY, OWNER_ID, SUPPORT_CHAT, dispatcher
...
__help__ = f"""
Chatbot utilizes the CoffeeHouse API and allows Ichigo to talk and provides a more interactive group chat experience.
