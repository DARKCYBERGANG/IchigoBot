...
from Ichigo.modules.helper_funcs.msg_types import Types
from Ichigo.modules.sql import BASE, SESSION
from sqlalchemy import BigInteger, Boolean, Column, Integer, String, UnicodeText

DEFAULT_WELCOME = "konnichiwa {first}, wazzup ?"
DEFAULT_GOODBYE = "Seeya!"

DEFAULT_WELCOME_MESSAGES = [
    "{first} is here!",  # Discord welcome messages copied
    "Ready player {first}",
    "zero two, {first} is here.",
    ...
    "Welcome {first}, Avoid me if you can!",
    ...
    "may be someone in the matrix oh no its {first}!",
]
