...
import telegram
from Ichigo import TIGERS, WOLVES, dispatcher
...
from Ichigo.modules.helper_funcs.string_handling import split_quotes
from Ichigo.modules.log_channel import loggable
from Ichigo.modules.sql import warns_sql as sql
...
def warn(
    ...
    if num_warns >= limit:
        ...
        # message.bot.send_sticker(chat.id, BAN_STICKER)  # Ichigo's sticker
        keyboard = None
        log_reason = (
